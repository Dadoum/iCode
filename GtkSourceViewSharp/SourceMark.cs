...
#region Autogenerated code
	public partial class SourceMark {

		public SourceMark (IntPtr raw) : base(raw) {}
		...
		public SourceMark (string name, string category) : base (IntPtr.Zero)
		{
			if (GetType () != typeof (SourceMark)) {
		...
		public Gtk.SourceMark Next(string category) {
			IntPtr native_category = GLib.Marshaller.StringToPtrGStrdup (category);
			IntPtr raw_ret = gtk_source_mark_next(Handle, native_category);
			Gtk.SourceMark ret = GLib.Object.GetObject(raw_ret) as Gtk.SourceMark;
			GLib.Marshaller.Free (native_category);
			return ret;
		}
		...
		public Gtk.SourceMark Prev(string category) {
			IntPtr native_category = GLib.Marshaller.StringToPtrGStrdup (category);
