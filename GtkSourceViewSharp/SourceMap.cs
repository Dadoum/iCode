...
#region Autogenerated code
	public partial class SourceMap : Gtk.SourceView {

		public SourceMap (IntPtr raw) : base(raw) {}

		[DllImport("gtksourceview-4", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_source_map_new();

		public SourceMap () : base (IntPtr.Zero)
		{
			if (GetType () != typeof (SourceMap)) {
		...
		static uint class_offset = ((GLib.GType) typeof (Gtk.SourceView)).GetClassSize ();
