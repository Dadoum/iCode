...
#region Autogenerated code
	public partial class SourceSearchSettings : GLib.Object {

		public SourceSearchSettings (IntPtr raw) : base(raw) {}

		[DllImport("gtksourceview-4", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr gtk_source_search_settings_new();

		public SourceSearchSettings () : base (IntPtr.Zero)
		{
			if (GetType () != typeof (SourceSearchSettings)) {
