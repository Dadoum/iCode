...
{
	public class DeviceSelectorWindow : Dialog, IGladeWidget, IDialog
	{
...
#pragma warning restore 649
		...
		public string ResourceName => "DeviceSelector";
		public string WidgetName => "DeviceSelectorWindow";
		...
		public void Initialize()
		{
			...
			var idevice = LibiMobileDevice.Instance.iDevice;
			var deviceLockdown = LibiMobileDevice.Instance.Lockdown;
			...
			else
			{
				...
				foreach (var udid in udids)
				{
					...
					LockdownClientHandle lockdownHandle;
					deviceLockdown.lockdownd_client_new_with_handshake(deviceHandle, out lockdownHandle, "Quamotion").ThrowOnError();

					string deviceName;
					deviceLockdown.lockdownd_get_device_name(lockdownHandle, out deviceName).ThrowOnError();
