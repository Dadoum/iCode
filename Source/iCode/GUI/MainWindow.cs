...
#pragma warning restore 649
        ...
        public MainWindow(Builder builder, IntPtr handle) : base(handle)
        {
            try
            {
                ...
                master.SwitcherStyle = SwitcherStyle.Tabs;
                ...
                var tmp = new Label();
                var color = tmp.StyleContext.GetColor(StateFlags.Normal);
        ...
        private readonly ProjectExplorerWidget projectExplorerView = ProjectExplorerWidget.Create();
        private readonly PropertyWidget propertyWidgetView = PropertyWidget.Create();
